...
solution file add ./convTestbench_Jo.cpp -type C++ -exclude true
solution file add ./convREF_Jo.cpp -type C++ -exclude true
solution file add ./convHW_Jo.cpp -type C++
...
go new
directive set -DESIGN_HIERARCHY __CPR180__convolution3D_HW__FP75ac_fixed__tm__59_XCiL_1_8XCiL_1_3XCbL_1_1XC9ac_q_modeL_1_4XC9ac_o_modeL_1_1T1P76ac_fixed__tm__60_XCiL_2_12XCiL_1_6XCbL_1_1XCJ65JL_1_0XCJ82JL_1_1T1
go compile
...
go assembly
directive set /convolution3D_HW/core/kernel2D:rsc -BLOCK_SIZE 9
directive set /convolution3D_HW/core/SHIFT_REG_NEW_LINE_MAIN:for -UNROLL yes
directive set /convolution3D_HW/core/CONV2D_COLUMN_LOOP -PIPELINE_INIT_INTERVAL 2
directive set /convolution3D_HW/core/pixelCalcHW_simple:for -UNROLL yes
directive set /convolution3D_HW/core/SHIFT_REG_NEW_PIXEL_MAIN -UNROLL yes
directive set /convolution3D_HW/core/FILL_KERNEL_LOOP -PIPELINE_INIT_INTERVAL 1
directive set /convolution3D_HW/core/FILL_PADDED_IMG_MAIN_LOOP -PIPELINE_INIT_INTERVAL 1
directive set /convolution3D_HW/core/SHIFT_REG_NEW_LINE_MAIN -UNROLL yes
go architect
go extract
