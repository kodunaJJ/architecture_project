...
#define BIAS_CONVLAYER3_WEIGHT_DATA_WIDTH 8
...
#define CONVLAYER1_INTERN_PROD_DATA_WIDTH 13 /* 14bits min to change for dim | 12b possible*/
...
#define CONVLAYER2_INTERN_PROD_DATA_WIDTH (MAXPOOL_LAYER1_DATA_WIDTH+7-4) /* 7b=frac part ker2+1b->ker2MaxVal=1.14  
15bits if 8b x 8b or 16bits if 8b x 9b for full size result*/
#define CONVLAYER2_INTERN_PROD_DATA_INT_WIDTH (MAXPOOL_LAYER1_DATA_INT_WIDTH-2)
					       
#define CONV2DLAYER2_INTERN_SUM_DATA_WIDTH (CONVLAYER2_INTERN_PROD_DATA_WIDTH+LOG2_9-4)
#define CONV2DLAYER2_INTERN_SUM_DATA_INT_WIDTH (CONVLAYER2_INTERN_PROD_DATA_INT_WIDTH+LOG2_9-4)

#define CONVLAYER3_INTERN_PROD_DATA_WIDTH (MAXPOOL_LAYER2_DATA_WIDTH+6-6)
#define CONVLAYER3_INTERN_PROD_DATA_INT_WIDTH (MAXPOOL_LAYER2_DATA_INT_WIDTH-2) /* 6b | 7b should be enougth */
					       
#define CONV2DLAYER3_INTERN_SUM_DATA_WIDTH (CONVLAYER3_INTERN_PROD_DATA_WIDTH+LOG2_9-4)
#define CONV2DLAYER3_INTERN_SUM_DATA_INT_WIDTH (CONVLAYER3_INTERN_PROD_DATA_INT_WIDTH+LOG2_9-4)
...
#define PERCEPTRON_INTERN_SUM_DATA_WIDTH (PERCEPTRON_INTERN_PROD_DATA_WIDTH+LOG2_180-8)
#define PERCEPTRON_INTERN_SUM_DATA_INT_WIDTH (PERCEPTRON_INTERN_PROD_DATA_INT_WIDTH+LOG2_180-4)

#define PERCEPTRON_BIAS_SUM_DATA_WIDTH (PERCEPTRON_INTERN_SUM_DATA_WIDTH)
#define PERCEPTRON_BIAS_SUM_DATA_INT_WIDTH (PERCEPTRON_INTERN_SUM_DATA_INT_WIDTH)
...
typedef ac_fixed< CONV2DLAYER2_INTERN_SUM_DATA_WIDTH+LOG2_64-5,CONV2DLAYER2_INTERN_SUM_DATA_INT_WIDTH+LOG2_64-5 ,true,
  AC_TRN , AC_SAT> convLayer2InternOut_dataType;
...
typedef ac_fixed<CONV2DLAYER3_INTERN_SUM_DATA_WIDTH+LOG2_32-7,CONV2DLAYER3_INTERN_SUM_DATA_INT_WIDTH+LOG2_32-7,
