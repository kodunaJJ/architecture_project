...
#define CONVLAYER1_OUT_DATA_INT_WIDTH 7
...
#define CONVLAYER2_OUT_DATA_WIDTH 14 /* to change for dim */
...
#define CONVLAYER2_INTERN_PROD_DATA_WIDTH (MAXPOOL_LAYER1_DATA_WIDTH+7) /* 7b=frac part ker2+1b->ker2MaxVal=1.14  
15bits if 8b x 8b or 16bits if 8b x 9b */
#define CONVLAYER2_INTERN_PROD_DATA_INT_WIDTH (MAXPOOL_LAYER1_DATA_INT_WIDTH+1)
